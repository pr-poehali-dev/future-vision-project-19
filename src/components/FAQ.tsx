...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Привозите мебель к нам в мастерскую самостоятельно. При заказе от 5 стульев, 2 кресел или 4 пуфов — берём доставку на себя. Работаем по всей Москве.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Да, даём гарантию 12 месяцев на швы и обивку. Гарантия действует при бытовом использовании в нормальных условиях: без порезов, намеренных повреждений, воздействия влаги, прямых солнечных лучей и контакта с домашними животными. Если ткань расползлась или шов разошёлся по нашей вине — переделаем бесплатно.",
  },
  {
