...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Стул или кресло — 1–2 дня. Диван — 3–5 дней. Если срочно — сделаем быстрее, скажите при заказе.",
  },
  {
    question: "Нужно ли везти мебель к вам?",
    answer:
      "Нет, мы сами приедем, заберём мебель и привезём обратно. Бесплатный вывоз и доставка по городу.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Напишите нам или позвоните — опишите мебель или пришлите фото. Мы ответим с ценой и запишем на удобное время.",
  },
]
