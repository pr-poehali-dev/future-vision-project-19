...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Да, даём гарантию 3 месяца на швы и обивку. Гарантия действует при бытовом использовании в нормальных условиях: без порезов, намеренных повреждений, воздействия влаги, прямых солнечных лучей и контакта с домашними животными. Если ткань расползлась или шов разошёлся по нашей вине — переделаем бесплатно.",
  },
  {
